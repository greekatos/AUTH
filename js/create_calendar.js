...
!(function () {
  ...
  Calendar.prototype.draw = function () {
    ...
    console.log(document.getElementsByClassName(".legend") !== null);
    // Draw Legend
    this.drawLegend();
  };
  ...
  Calendar.prototype.drawHeader = function () {
    ...
    if (!this.header) {
      ...
      this.header = createElement("div", "calendar_header");
  ...
  Calendar.prototype.drawMonth = function () {
    ...
    this.events.forEach(function (ev) {
      ev.date = moment(ev.key, "DD/MM/YYYY");
    });

    if (this.month) {
      self.el.removeChild(self.el.querySelector(".legend"));
      ...
      this.oldMonth.addEventListener("webkitAnimationEnd", function () {
        ...
        // set Timeout function allows browser to reflow and repaint the page with the new class, which then triggers the anomation
        self.legend_div = window.setTimeout(function () {
  ...
  Calendar.prototype.drawDay = function (day) {
    ...
    outer.addEventListener("click", function () {
      ...
      days.forEach((day) => {
        if (Object.values(day.classList).includes("selectedDay"))
          day.classList.remove("selectedDay");
      });
      outer.classList.add("selectedDay");
    });
  ...
  Calendar.prototype.openDay = function (el) {
    ...
    //
    const dayDiv = el.getBoundingClientRect();
    const arrowDiv = arrow.getBoundingClientRect();
    const arrowMiddle = dayDiv.width / 2 - arrowDiv.width / 2;
    arrow.style.left = el.offsetLeft + arrowMiddle + "px";
  };
  ...
  Calendar.prototype.renderEvents = function (events, ele) {
    ...
    events.forEach(function (ev) {
      ...
      a_el.addEventListener("click", function (e) {
        window.location.href = ev.link + "?uuid=" + encodeURIComponent(ev.id);
      });
...
!(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    script.src = "js/event_data.js";
    document.head.appendChild(script);

    script.addEventListener("load", function () {
      var calendar = new Calendar("#event_calendar", data);
    });
  });

  // Changes calendar arrow position when the window is resized
  window.addEventListener("resize", function (event) {
    let daygrid = document.querySelector(".selectedDay");
    let arrow = document.querySelector(".arrow");
    if (daygrid) {
      const dayDiv = daygrid.getBoundingClientRect();
      const arrowDiv = arrow.getBoundingClientRect();
      const arrowMiddle = dayDiv.width / 2 - arrowDiv.width / 2;
      arrow.style.left = daygrid.offsetLeft + arrowMiddle + "px";
    }
  });
})();
