...
function sort_Dates(jsonArray){
    return jsonArray.sort((a, b) => {
        return moment(a.key, "DD/MM/YYYY").diff(moment(b.key, "DD/MM/YYYY"));
    });
}
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    exhibition_data_sorted = sort_Dates(exhibition_data);
    console.log(exhibition_data_sorted);
    for (let i = 0; i < exhibition_data_sorted.length; i++) {

        let cardDiv = document.createElement("div");
        let newDiv = document.createElement('div');
        let new_Anchor = document.createElement("a");
        let category_Title = document.createElement("h3");
        let date_Title = document.createElement("h3");
        let exhibition_Title = document.createElement("h2");
        let exhibition_Image = document.createElement("div");
        ...
        //new Div
        newDiv.classList.add('card-content');
        
        //category_Title
        category_Title.classList.add("exhibitions-exhibitions");
        category_Title.textContent = exhibition_data_sorted[i].category;

        //date_Title
        date_Title.classList.add("exhibition-date");
        date_Title.textContent = "Date:" + exhibition_data_sorted[i].key

        //exhibition_Title
        exhibition_Title.classList.add("exhibition-title");
        exhibition_Title.textContent = exhibition_data_sorted[i].exhibitionName

        //exhibition_Image
        exhibition_Image.classList.add("exhibition-image");
        img.classList.add("exhibition-img");
        img.src = exhibition_data_sorted[i].image;
        img.alt = exhibition_data_sorted[i].exhibitionName;
        exhibition_Image.appendChild(img);
        
        //new_Anchor
        newDiv.appendChild(new_Anchor);

        //Add kids
        new_Anchor.appendChild(category_Title);
        new_Anchor.appendChild(date_Title);
        new_Anchor.appendChild(exhibition_Title);
        new_Anchor.appendChild(exhibition_Image);
        new_Anchor.href = exhibition_data_sorted[i].link + "?uuid=" + exhibition_data_sorted[i].id;
